import { cappitalizeFirstLetter, directionOfwWind } from "./helper.js";
...
description.textContent = cappitalizeFirstLetter(data.weather[0].description);
...
weatherInfoList.append(weatherInfoWind, weatherInfoPressure, weatherInfoHumidity, weatherInfoClouds);
